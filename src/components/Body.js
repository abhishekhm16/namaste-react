...
const Body = function () {
  ...
  async function fetchData() {
    const data = await fetch(
      "https://corsproxy.io/?https://www.swiggy.com/dapi/restaurants/list/v5?lat=14.4534208&lng=75.9129349&is-seo-homepage-enabled=true&page_type=DESKTOP_WEB_LISTING"
    );
